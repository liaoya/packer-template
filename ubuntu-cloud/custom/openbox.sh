...
[[ -n $SSH_USERNAME ]] && su -l $SSH_USERNAME -c 'mkdir -p ~/.config/openbox; echo "xterm &" > ~/.config/openbox/autostart; echo "xcompmgr &" >> ~/.config/openbox/autostart; echo "cairo-dock &" >> ~/.config/openbox/autostart'
