...
packer build -var "vm_name=minikube" -var "custom_docker_ce=true" -var "custom_libvirt=true" -var "custom_python_virtualenv=true" -var "disk_size=65536" -var-file ../conf/centos7.json -var-file ../conf/jaist.json -var-file ../conf/lab.json centos.json

packer build -var "vm_name=develop" -var "custom_docker_ce=true" -var "custom_java=true" -var "custom_nvm=true" -var "custom_python_virtualenv=true" -var-file ../conf/centos7.json -var-file ../conf/jaist.json -var-file ../conf/lab.json centos.json

packer build -var "vm_name=kubernetes" -var "custom_docker_ce=true" -var "custom_python_virtualenv=true" -var "custom_kubernetes=true" -var-file ../conf/centos7.json -var-file ../conf/jaist.json -var-file ../conf/lab.json centos.json
```
