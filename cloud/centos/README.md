...
packer build -var "vm_name=kubernetes" -var "custom_docker=true" -var "custom_python_virtualenv=true" -var "custom_kubernetes=true" -var-file ../conf/centos7.json -var-file ../conf/jaist.json -var-file ../conf/lab.json centos.json
```
