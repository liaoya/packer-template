...
packer build -var "vm_name=develop" -var "custom_java=true" -var "custom_nvm=true" -var "custom_docker=true" -var-file ../conf/centos7.json -var-file ../conf/jaist.json -var-file ../conf/lab.json centos.json
```
