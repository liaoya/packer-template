...
packer build -var "vm_name=develop" -var "custom_docker_ce=true" -var "custom_java=true" -var "custom_nvm=true" -var-file ../conf/fedora29.json -var-file ../conf/jaist.json -var-file ../conf/lab.json fedora.json

packer build -var "vm_name=libvirt" -var "custom_libvirt=true" -var-file ../conf/fedora29.json -var-file ../conf/jaist.json -var-file ../conf/lab.json fedora.json
```
