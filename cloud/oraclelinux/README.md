...
packer build -var "vm_name=develop" -var "custom_asdf=true" -var "custom_docker=true" -var "custom_java=true" -var "custom_nvm=true" -var "iso_name=${image_name}" -var "iso_checksum=${image_checksum}" -var "oracle_name=oraclelinux76" -var "ssh_password=vagrant" -var "ssh_username=vagrant" -var-file ../conf/proxy.json oraclelinux.json
```
